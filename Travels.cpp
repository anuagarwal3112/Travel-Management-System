...
public:
    ...
    void getDetails()
    {
        ofstream out("old-customers.text", ios::app); //open file using append mode to write customer details
        {
            cout << "\nEnter Customer ID: ";
            cin >> cusID;
            cout << "Enter Name: ";
    ...
    {
        ifstream in("old-customers.text");
        {
            if(!in)
            {
...
public:
    ...
    void hotels()
    {
        string hotelNo[] = {"Avendr", "ChoiceYou", "ElephantBay"};
        for(int a = 0; a < 3; a++)
        {
        ...
        if(choiceHotel == 1){
            ...
            cout << "\tLive a Luxury at Avendr: Rs.15000.00" << endl;
            ...
            if (packChoice1 == 1){
                hotelCost = 5000.00;
                cout << "\nYou have successfully booked Standard Pack at Avendr" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2){
                hotelCost = 10000.00;
                cout << "\nYou have successfully booked Premium Pack at Avendr" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3){
                hotelCost = 15000.00;
                cout << "\nYou have successfully booked Luxury Pack at Avendr" << endl;
                cout << "Goto Menu to take the receipt" << endl;
            }
            else{
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
